...
% Vordefinierte Umgebungen für Theoreme/Lemmas/Definitionen (Beamer native support)
% Beamer provides built-in theorem environments, we just define the ones we need
