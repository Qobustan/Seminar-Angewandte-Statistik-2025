...
\author{Yavuzâlp Dal}
\title[Der Fibonacci-Heap]{Eine sehr wertvolle Datenstruktur f\"ur die Theorie: \\ Der Fibonacci - Heap}
\subject{Schriftliche Ausarbeitung zum Seminarvortrag}
\def \vorlesung {Bachelor-Seminar: Algorithmenentwurf und Analyse}
\def \semester {Wintersemester 2023/24}
\def \dozent {Dr. Daniel Schmidt}
\date{Stand: \today}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
