...
% HINWEIS: \bibliographystyle wird nicht benötigt, da biblatex im Hauptdokument verwendet wird
% Der Zitierstil wird direkt bei \usepackage[backend=bibtex, style=alphabetic]{biblatex} festgelegt
% Zitatstil: Sinnvolle Alternativen: alpha, alphabetic, numeric, authoryear
